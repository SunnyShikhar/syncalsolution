...
<html lang="en">
	...
	<body class="landing">
		...
		<?php
				...
				// Query Template
				$query = "SELECT S.synNum, S.serialNum, S.comment, S.cal_pm, S.modelNum, S.prodOwnerEmail, M.manuName, P.deptName " .
						 "FROM syntool S, prodOwner P, manufTool M" .
						 "WHERE M.manuName=? AND P.deptName=?";
				...
				$stmt->bind_result($synNum, $serialNum, $comment, $cal_pm, $modelNum, $prodOwnerEmail, $manuName, $deptName);
		?>
